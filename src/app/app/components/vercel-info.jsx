...
export const VercelInfo = async ({ info }) => {
	...
	const turboIcon = isUsingTurbopack
		? <Popover button={<Image alt='loading' height={16} width={16} style={{ fontSize: 'medium' }} src='https://turbo.build/images/docs/pack/turbo-benchmark-icon-dark.svg' />} content={<span>Using Turbopack</span>} />
		: null;
