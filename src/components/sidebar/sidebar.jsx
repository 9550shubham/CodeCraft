...
//   const [logoImage, setLogoImage] = useState('/imgs/Formal_DP.jpg');
//   const [showCodeCraft, setShowCodeCraft] = useState(false);
...
//     if (pathname === '/') {
//       setLogoImage(null);
//       setShowCodeCraft(true);
//     } else {
//       setLogoImage('/imgs/Formal_DP.jpg');
//       setShowCodeCraft(false);
//     }
//   }, [pathname]);
...
const Sidebar = () => {
  ...
  useEffect(() => {
    // No need for conditional state update here since rendering logic will handle it
  }, [pathname]);
